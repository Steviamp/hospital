...
namespace PapageorgiouHospitalQueueSystem.Services
{
    public class PatientService : IPatientService
    {
        ...
        public PatientService(AppDbContext context, IHubContext<QueueHub> hubContext, IAesEncryptionHelper encryption)
        {
            _context = context;
        ...
        public async Task<Patient> CreatePatientAsync(Patient patient)
        {
            ...
            patient.Name = _encryption.Encrypt(patient.Name);
        ...
        public async Task<Patient?> ReleasePatientAsync(int patientId)
        {
            ...
            var officeId = patient.CurrentDoctorsOfficeId;
            patient.Status = 0;
